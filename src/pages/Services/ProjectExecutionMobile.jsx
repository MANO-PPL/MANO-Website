                ...
                <>
                        ...
                        <div className="max-w-7xl mx-auto px-4">
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center lg:divide-x divide-white/10">
                                <div className="p-2.5">
                                    ...
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">On-Time Project Delivery Rate</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={90} suffix="%" />+</h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Schedule Adherence Across Projects</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={30} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Reduction in Execution Delays</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5">Zero</h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Critical Execution Failures</p>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div className="max-w-7xl mx-auto">
                                ...
                                <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-24 items-start">
                                    ...
                                    <div className="space-y-4 sm:space-y-6 text-right lg:pr-12 relative group">
                                        ...
                                        <h3 className="text-xl sm:text-2xl font-bold text-red-500 mb-4 sm:mb-6">Without Professional Execution</h3>
                                    ...
                                    <div className="space-y-4 sm:space-y-6 text-left lg:pl-12 relative group">
                                        ...
                                        <h3 className="text-xl sm:text-2xl font-bold text-blue-500 mb-4 sm:mb-6">With MANO Execution Services</h3>
                                    ...
                                    <div className="relative z-10 grid grid-cols-2 gap-3">
                                        <div className="space-y-3 mt-6">
                                            ...
                                            <div className="h-32 sm:h-40 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-800 p-4 sm:p-6 flex flex-col justify-center">
                                                <span className="text-white text-base sm:text-lg font-bold">Quality<br />Assured</span>
                                            </div>
                                        </div>
                                        <div className="space-y-3">
                                            <div className="h-32 sm:h-40 rounded-2xl bg-[#111] border border-white/10 p-4 sm:p-6 flex flex-col justify-center">
                                                ...
                                                <span className="text-sm sm:text-base text-gray-300 font-medium">Safety First</span>
                                            </div>
                                            <div className="h-52 sm:h-64 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl p-4 sm:p-6 flex flex-col justify-end">
                        ...
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto">
                                <div className="text-center mb-8 md:mb-20">
                                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight">Project Execution <span className="text-blue-500">Process Flow</span></h2>
                                    <div className="h-1 w-24 bg-blue-500/30 mx-auto rounded-full"></div>
                                </div>

                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                    {processFlow.map((step, index) => (
                                        <div key={index} className="group relative p-4 sm:p-6 rounded-2xl border border-white/10 overflow-hidden hover:border-blue-500/30 transition-all shadow-lg backdrop-blur-xl bg-gradient-to-r from-transparent to-white/5 hover:to-blue-600/10 group h-full">
                                            {/* Top Line Accent */}
                    ...
                    <section className="py-10 md:py-24 relative overflow-hidden animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-800">
                        ...
                        <div className="max-w-4xl mx-auto px-4 md:px-12 text-center relative z-10">
                            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white mb-5 sm:mb-6 leading-tight">Execute with Precision. <br /> Deliver with Confidence.</h2>
...
export default ProjectExecutionMobile;
