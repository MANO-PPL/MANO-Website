                ...
                <>
                    ...
                    >
                        <div className="max-w-7xl mx-auto px-4">
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center lg:divide-x divide-white/10">
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={98} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Billing Accuracy After Audit</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={70} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Reduction in Overbilling</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={400} suffix="+" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Audits Completed</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={95} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Quantity Verification Accuracy</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section className="py-10 md:py-24 px-4 md:px-12 relative animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-100">
                                    ...
                                    {[
                                        ...
                                        <div key={index} className="group relative p-4 sm:p-8 rounded-2xl border border-white/10 overflow-hidden hover:border-blue-500/30 transition-all shadow-lg backdrop-blur-xl bg-gradient-to-r from-transparent to-white/5 hover:to-blue-600/10 animated-white-border">
                                            ...
                                            <div className="relative z-10">
                                                <div className="w-11 h-11 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl mb-4 sm:mb-8 bg-blue-600/10 border border-blue-500/20 flex items-center justify-center group-hover:scale-110 group-hover:bg-blue-500 group-hover:text-white transition-all duration-300 shadow-[0_0_20px_rgba(37,99,235,0.2)]">
                                                    <service.icon className="w-5 h-5 sm:w-8 sm:h-8 text-blue-400 group-hover:text-white transition-colors" />
                                                </div>

                                                <h3 className="text-lg sm:text-2xl font-bold text-white mb-3 sm:mb-4 group-hover:text-blue-300 transition-colors">{service.title}</h3>
                                                <p className="text-sm sm:text-lg text-gray-400 mb-4 sm:mb-8 leading-relaxed">{service.description}</p>

                                                <div className="bg-black/30 rounded-xl p-4 sm:p-6 border border-white/5 backdrop-blur-sm">
                                                    <h4 className="text-xs sm:text-sm font-semibold text-blue-400 mb-3 sm:mb-4 uppercase tracking-wide">Key Service:</h4>
                                                    <ul className="grid grid-cols-1 gap-2.5 sm:gap-3">
                                                        {service.details.map((detail, idx) => (
                                                            <li key={idx} className="flex items-start text-xs sm:text-sm text-gray-300">
                                                                <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-2 sm:mr-3 text-blue-500 shrink-0 mt-0.5" />
                                                                {detail}
                                                            </li>
                                                        ))}
                                                    </ul>
                    ...
                    <section className="py-10 md:py-24 px-4 md:px-12 relative overflow-hidden animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-300">
                        <div className="max-w-7xl mx-auto">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-12 items-stretch">
                                {/* LEFT: RED BAR (Without QS) */}
                                <RevealOnScroll>
                                    <div className="h-full bg-gradient-to-b from-red-950/30 to-black p-4 sm:p-10 rounded-2xl sm:rounded-[2.5rem] border border-red-500/20 text-center relative overflow-hidden group hover:border-red-500/50 transition-all duration-500 flex flex-col">
                                        ...
                                        <div className="relative z-10 flex flex-col h-full">
                                            <div className="mb-4 sm:mb-8 p-3 sm:p-4 bg-red-500/10 rounded-full w-14 h-14 sm:w-20 sm:h-20 flex items-center justify-center mx-auto border border-red-500/20">
                                                <AlertTriangle className="w-7 h-7 sm:w-10 sm:h-10 text-red-500" />
                                            </div>
                                            <h3 className="text-xl sm:text-3xl font-bold text-red-500 mb-4 sm:mb-8">Without Proper QS & Billing Audit</h3>

                                            <ul className="space-y-2.5 sm:space-y-5 text-left w-full pl-1 sm:pl-4 grow">
                                                <li className="flex items-start text-sm sm:text-lg text-gray-300"><span className="text-red-500 mr-2 sm:mr-3 text-base sm:text-xl">x</span> Overbilling & inflated quantities</li>
                                                <li className="flex items-start text-sm sm:text-lg text-gray-300"><span className="text-red-500 mr-2 sm:mr-3 text-base sm:text-xl">x</span> Financial leakages & hidden costs</li>
                                                <li className="flex items-start text-sm sm:text-lg text-gray-300"><span className="text-red-500 mr-2 sm:mr-3 text-base sm:text-xl">x</span> Incorrect measurement records</li>
                                                <li className="flex items-start text-sm sm:text-lg text-gray-300"><span className="text-red-500 mr-2 sm:mr-3 text-base sm:text-xl">x</span> Hidden discrepancies in bills</li>
                                                <li className="flex items-start text-sm sm:text-lg text-gray-300"><span className="text-red-500 mr-2 sm:mr-3 text-base sm:text-xl">x</span> No commercial transparency</li>
                                            </ul>

                                            <div className="mt-4 sm:mt-8 pt-4 sm:pt-8 border-t border-red-500/20">
                                                <p className="text-red-400 font-bold text-sm sm:text-xl uppercase tracking-wide">Result: Uncontrolled costs and inaccurate project financials.</p>
                                            </div>
                                        </div>
                                    </div>
                                </RevealOnScroll>
                                ...
                                <RevealOnScroll>
                                    <div className="h-full bg-gradient-to-b from-blue-950/30 to-black p-4 sm:p-10 rounded-2xl sm:rounded-[2.5rem] border border-blue-500/30 text-center relative overflow-hidden group hover:border-blue-400 transition-all duration-500 flex flex-col shadow-[0_0_50px_rgba(37,99,235,0.1)]">
                                        <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-blue-500 to-transparent"></div>

                                        <div className="relative z-10 flex flex-col h-full">
                                            <div className="mb-4 sm:mb-8 p-3 sm:p-4 bg-blue-500/10 rounded-full w-14 h-14 sm:w-20 sm:h-20 flex items-center justify-center mx-auto border border-blue-500/30 shadow-[0_0_20px_rgba(59,130,246,0.3)]">
                                                <CheckCircle className="w-7 h-7 sm:w-10 sm:h-10 text-blue-400" />
                                            </div>
                                            <h3 className="text-xl sm:text-3xl font-bold text-blue-400 mb-4 sm:mb-8">With MANO QS & Billing Audit Services</h3>

                                            <ul className="space-y-2.5 sm:space-y-5 text-left w-full pl-1 sm:pl-4 grow">
                                                <li className="flex items-start text-sm sm:text-lg text-gray-100"><BadgeCheck className="w-4 h-4 sm:w-6 sm:h-6 text-blue-400 mr-2 sm:mr-3 mt-0.5 shrink-0" /> Verified quantities</li>
                                                <li className="flex items-start text-sm sm:text-lg text-gray-100"><BadgeCheck className="w-4 h-4 sm:w-6 sm:h-6 text-blue-400 mr-2 sm:mr-3 mt-0.5 shrink-0" /> Transparent payments</li>
                                                <li className="flex items-start text-sm sm:text-lg text-gray-100"><BadgeCheck className="w-4 h-4 sm:w-6 sm:h-6 text-blue-400 mr-2 sm:mr-3 mt-0.5 shrink-0" /> Error-free documentation</li>
                                                <li className="flex items-start text-sm sm:text-lg text-gray-100"><BadgeCheck className="w-4 h-4 sm:w-6 sm:h-6 text-blue-400 mr-2 sm:mr-3 mt-0.5 shrink-0" /> Dispute prevention</li>
                                                <li className="flex items-start text-sm sm:text-lg text-gray-100"><BadgeCheck className="w-4 h-4 sm:w-6 sm:h-6 text-blue-400 mr-2 sm:mr-3 mt-0.5 shrink-0" /> Total financial clarity</li>
                                            </ul>

                                            <div className="mt-4 sm:mt-8 pt-4 sm:pt-8 border-t border-blue-500/30 bg-blue-500/5 -mx-4 sm:-mx-10 -mb-4 sm:-mb-10 p-4 sm:p-10">
                                                <p className="text-blue-300 font-bold text-sm sm:text-xl uppercase tracking-wide">Result: Accurate, controlled, transparent project finances.</p>
                                            </div>
                                        </div>
                                    </div>
                                </RevealOnScroll>
                    ...
                    <section className="py-10 md:py-24 px-4 md:px-12 bg-white/[0.02] animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-400">
                        <div className="max-w-7xl mx-auto">
                            <RevealOnScroll>
                                        ...
                                        <div className="relative z-10 grid grid-cols-2 gap-3">
                                            <div className="space-y-3 mt-6">
                                                <div className="h-52 sm:h-64 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl p-4 sm:p-6 flex flex-col justify-end">
                                                    <span className="text-3xl sm:text-4xl font-bold text-white mb-1.5 sm:mb-2">98%</span>
                                                ...
                                                <div className="h-32 sm:h-40 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-800 p-4 sm:p-6 flex flex-col justify-center">
                                                    <span className="text-white text-base sm:text-lg font-bold">No<br />Overbilling</span>
                                                </div>
                                            </div>
                                            <div className="space-y-3">
                                                <div className="h-32 sm:h-40 rounded-2xl bg-[#111] border border-white/10 p-4 sm:p-6 flex flex-col justify-center">
                                                    <FileText className="w-8 h-8 sm:w-10 sm:h-10 text-blue-500 mb-3 sm:mb-4" />
                                                    <span className="text-sm sm:text-base text-gray-300 font-medium">Fast Certification</span>
                                                </div>
                                                <div className="h-52 sm:h-64 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl p-4 sm:p-6 flex flex-col justify-end">
                                                    <span className="text-3xl sm:text-4xl font-bold text-white mb-1.5 sm:mb-2">Qty</span>
                        ...
                        <div className="max-w-7xl mx-auto">
                            <RevealOnScroll>
                                <div className="text-center mb-8 md:mb-24">
                                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mt-3 sm:mt-4 leading-tight">QS & Billing Audit Process Flow</h2>
                                </div>
                            </RevealOnScroll>
                                    ...
                                    {timelineSteps.map((step, i) => (
                                        <RevealOnScroll key={i}>
                                            <div className="flex flex-col items-center text-center group">
                                                ...
                                                {/* Content */}
                                                <div className="relative p-4 sm:p-6 rounded-2xl border border-white/10 overflow-hidden hover:border-blue-500/30 transition-all shadow-lg backdrop-blur-xl bg-gradient-to-r from-transparent to-white/5 hover:to-blue-600/10 group w-full min-h-[120px] sm:min-h-[140px] flex items-center justify-center">
                                                    ...
                                                    <h3 className="text-xs sm:text-sm font-bold text-white group-hover:text-blue-300 transition-colors leading-tight">{step}</h3>
                                                </div>
                                            </div>
                                        </RevealOnScroll>
                                    ))}
                    ...
                    <section className="py-10 md:py-24 relative overflow-hidden animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-800">
                        ...
                        <div className="max-w-4xl mx-auto px-4 md:px-12 text-center relative z-10">
                            <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-5 sm:mb-6 leading-tight">
...
export default QSAndAuditingMobile;
