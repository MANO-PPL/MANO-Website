                                ...
                                <div>
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-12 pr-5 py-3.5 text-base rounded-xl bg-white/5 border ${errors.mobile ? 'border-red-500/70' : 'border-white/10'} text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 hover:border-blue-500/30 transition-all`}
                                            value={formData.mobile}
                                            onChange={(e) => { setFormData({ ...formData, mobile: e.target.value }); if (errors.mobile) setErrors(prev => ({ ...prev, mobile: '' })); }}
                                        />
                                    </div>
                                    {errors.mobile && <p className="mt-1 ml-1 text-sm text-red-400">{errors.mobile}</p>}
                                </div>
