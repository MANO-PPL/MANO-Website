...
const ContactModalDesktop = ({ isOpen, onClose, initialService = '' }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 pointer-events-auto">
            ...
            <div className="relative w-full max-w-2xl rounded-3xl p-1 z-10 animate-modal-zoom">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-12 pr-5 py-3.5 text-base rounded-xl bg-white/5 border ${errors.name ? 'border-red-500/70' : 'border-white/10'} text-white placeholder-gray-500 focus:outline-none focus:bg-white/10 focus:border-blue-500/50 hover:border-blue-500/30 transition-all font-medium`}
                                />
                            </div>
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-5 py-3.5 text-base rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:bg-white/10 focus:border-blue-500/50 hover:border-blue-500/30 transition-all font-medium"
                            />
                        </div>
                        ...
                        <div>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-12 pr-5 py-3.5 text-base rounded-xl bg-white/5 border ${errors.email ? 'border-red-500/70' : 'border-white/10'} text-white placeholder-gray-500 focus:outline-none focus:bg-white/10 focus:border-blue-500/50 hover:border-blue-500/30 transition-all font-medium`}
                                />
                            </div>
                        ...
                        <div className="md:col-span-2">
                            <div className="relative group">
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        className={`w-full pl-12 pr-5 py-3.5 text-left rounded-xl bg-white/5 border ${errors.service ? 'border-red-500/70' : 'border-white/10'} text-white focus:outline-none focus:bg-white/10 focus:border-blue-500/50 hover:border-blue-500/30 transition-all font-medium text-base flex justify-between items-center`}
                                    >
                                        ...
                                        <div className="absolute top-full left-0 right-0 mt-2 bg-[#111] border border-white/10 rounded-xl shadow-xl overflow-hidden z-30 max-h-60 overflow-y-auto">
                                            {services.map((service, index) => (
                                                <button
                                                    ...
                                                    className="w-full text-left px-5 py-3 text-base text-gray-300 hover:bg-blue-600/20 hover:text-white transition-colors"
                                                >
                                                    {service}
                                                </button>
                                            ))}
                            ...
                            {errors.service && <p className="mt-1 ml-1 text-sm text-red-400">{errors.service}</p>}
                        </div>
                        ...
                        <div className="relative group md:col-span-2">
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full pl-12 pr-5 py-3.5 text-base rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:bg-white/10 focus:border-blue-500/50 hover:border-blue-500/30 transition-all resize-none font-medium"
                            />
                        </div>
                    </div>
...
export default ContactModalDesktop;
