            ...
            <section className="relative py-16 px-6 text-center overflow-hidden border-t border-white/5 bg-gradient-to-b from-black to-blue-950/30">
                ...
                <RevealOnScroll>
                    <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center gap-4">
                        ...
                        <h2 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-t from-gray-500 to-white pb-2 ">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
                            {[
                                ...
                                <div
                                    key={item.name}
                                    className="group relative p-8 rounded-2xl border border-white/10 backdrop-blur-xl bg-gradient-to-r from-transparent to-white/5 hover:to-blue-600/10 hover:border-blue-500/30 transition-all duration-300 flex flex-col items-start gap-4 shadow-lg overflow-hidden animated-white-border text-left"
                                >
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-gray-300 text-lg leading-relaxed font-light">{item.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto text-left">
                        ...
                        <div className="mt-20 sm:mt-32">
                            ...
                            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-6 sm:py-8 backdrop-blur-xl">
                                ...
                                >
                                    <div className="animate-marquee flex gap-4 sm:gap-8  px-4 group-hover:[animation-play-state:paused]">
                                        {[
                                            ...
                                            <div key={i} className="flex-shrink-0 px-8 py-4 rounded-xl border border-white/5 bg-white/5 text-center transition-all hover:bg-blue-600/10 hover:border-blue-500/30">
                                                <p className="text-sm text-gray-300 font-medium ">{member}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
