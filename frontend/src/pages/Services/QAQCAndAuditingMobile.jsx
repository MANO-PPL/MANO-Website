        ...
        <div className="min-h-screen bg-blue-pattern text-white overflow-x-hidden font-sans selection:bg-blue-500/30">
            ...
            {isLoaded && (
                <>
                    ...
                    >
                        <div className="max-w-7xl mx-auto px-4">
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center lg:divide-x divide-white/10">
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={92} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Reduction in Rework</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={98} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Compliance Accuracy</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={400} suffix="+" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">QA/QC Audits</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-5xl font-bold text-white mb-1.5"><CountUp end={90} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-sm uppercase tracking-wider">Faster Resolution</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="py-10 md:py-24 px-4 md:px-12 relative z-10 overflow-hidden animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-300">
                        <div className="max-w-7xl mx-auto relative">
                            ...
                            <div ref={chartRef} className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-12 items-center">
                                {/* LEFT: RED DONUT (Risk) */}
                                <RevealOnScroll>
                                    <div className="bg-gradient-to-br from-red-900/10 to-transparent p-4 sm:p-8 rounded-2xl sm:rounded-3xl border border-red-500/20 text-center relative overflow-hidden group hover:border-red-500/40 transition-all duration-500">
                                        <div className="absolute inset-0 bg-red-500/5 group-hover:bg-red-500/10 transition-colors duration-500"></div>

                                        <div className="relative z-10 flex flex-col items-center">
                                            <h3 className="text-xl sm:text-2xl font-bold text-red-500 mb-4 sm:mb-6">Without QA & Audit</h3>

                                            {/* Horizontal Bar Chart Visual - Red (Risk) */}
                                            <div className="w-full max-w-xs mb-4 sm:mb-8">
                                                <div className="flex justify-between items-end mb-2">
                                                    <span className="text-4xl sm:text-5xl font-bold text-white drop-shadow-xl tracking-tighter">80%</span>
                                                    <span className="text-xs sm:text-sm text-red-300 font-bold uppercase tracking-widest pb-1.5 sm:pb-2">Risk Level</span>
                                                </div>
                                                <div className="h-5 sm:h-6 w-full bg-gray-700/50 rounded-full overflow-hidden backdrop-blur-sm border border-gray-600/30">
                                                    <div
                                            ...
                                            <ul className="space-y-2.5 sm:space-y-4 text-left w-full max-w-sm px-1 sm:px-6">
                                                <li className="flex items-start text-xs sm:text-base text-gray-300 font-medium"><AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5 text-red-500 mr-2 sm:mr-3 mt-0.5 shrink-0" /> Frequent defects & hidden issues</li>
                                                <li className="flex items-start text-xs sm:text-base text-gray-300 font-medium"><Activity className="w-4 h-4 sm:w-5 sm:h-5 text-red-500 mr-2 sm:mr-3 mt-0.5 shrink-0" /> High rework costs (&gt;15%)</li>
                                                <li className="flex items-start text-xs sm:text-base text-gray-300 font-medium"><FileText className="w-4 h-4 sm:w-5 sm:h-5 text-red-500 mr-2 sm:mr-3 mt-0.5 shrink-0" /> No audit trail</li>
                                            </ul>
                                        </div>
                                    </div>
                                </RevealOnScroll>
                                ...
                                <RevealOnScroll>
                                    <div className="bg-gradient-to-br from-blue-900/20 to-transparent p-4 sm:p-10 rounded-2xl sm:rounded-[2.5rem] border border-blue-500/20 text-center relative overflow-hidden group hover:border-blue-500/50 transition-all duration-500 shadow-2xl shadow-blue-900/10">
                                        <div className="absolute inset-0 bg-blue-500/5 group-hover:bg-blue-500/10 transition-colors duration-500"></div>

                                        <div className="relative z-10 flex flex-col items-center">
                                            <h3 className="text-xl sm:text-3xl font-bold text-blue-400 mb-4 sm:mb-8 tracking-tight">With MANO QA</h3>

                                            {/* Horizontal Bar Chart Visual - Blue (Quality) */}
                                            <div className="w-full max-w-xs mb-4 sm:mb-8">
                                                <div className="flex justify-between items-end mb-2">
                                                    <span className="text-4xl sm:text-5xl font-bold text-white drop-shadow-xl tracking-tighter">98%</span>
                                                    <span className="text-xs sm:text-sm text-blue-300 font-bold uppercase tracking-widest pb-1.5 sm:pb-2">Quality Score</span>
                                                </div>
                                                <div className="h-5 sm:h-6 w-full bg-gray-700/50 rounded-full overflow-hidden backdrop-blur-sm border border-gray-600/30">
                                                    <div
                                            ...
                                            <ul className="space-y-2.5 sm:space-y-4 text-left w-full max-w-sm px-1 sm:px-6">
                                                <li className="flex items-start text-xs sm:text-base text-gray-200 font-medium"><ShieldCheck className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400 mr-2 sm:mr-3 mt-0.5 shrink-0" /> Zero-defect handover</li>
                                                <li className="flex items-start text-xs sm:text-base text-gray-200 font-medium"><Target className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400 mr-2 sm:mr-3 mt-0.5 shrink-0" /> 98% Compliance rate</li>
                                                <li className="flex items-start text-xs sm:text-base text-gray-200 font-medium"><CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400 mr-2 sm:mr-3 mt-0.5 shrink-0" /> Audit-ready records</li>
                                            </ul>
                                        </div>
                                    </div>
                                </RevealOnScroll>
                                    ...
                                    <div className="relative z-10 grid grid-cols-2 gap-3">
                                        <div className="space-y-3 mt-6">
                                            ...
                                            <div className="h-32 sm:h-40 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-800 p-4 sm:p-6 flex flex-col justify-center">
                                                <span className="text-white text-base sm:text-lg font-bold">Error<br />Free</span>
                                            </div>
                                        </div>
                                        <div className="space-y-3">
                                            <div className="h-32 sm:h-40 rounded-2xl bg-[#111] border border-white/10 p-4 sm:p-6 flex flex-col justify-center">
                                                ...
                                                <span className="text-sm sm:text-base text-gray-300 font-medium">High Benchmarks</span>
                                            </div>
                                            <div className="h-52 sm:h-64 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl p-4 sm:p-6 flex flex-col justify-end">
                    ...
                    <section className="py-10 md:py-24 relative overflow-hidden animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-800">
                        ...
                        <div className="max-w-4xl mx-auto px-4 md:px-12 text-center relative z-10">
                            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white mb-5 sm:mb-6 leading-tight">Quality You Can Trust. Compliance You Can Prove.</h2>
...
export default QAQCAndAuditingMobile;
