                ...
                <>
                    ...
                    >
                        <div className="max-w-7xl mx-auto px-4">
                            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 text-center lg:divide-x divide-white/10">
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-2"><CountUp end={100} suffix="+" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-xs uppercase tracking-wider">EPC Projects Supported</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-2"><CountUp end={25} suffix="" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-xs uppercase tracking-wider">Happy Clients</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-2"><CountUp end={95} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-xs uppercase tracking-wider">Procurement Savings</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-2"><CountUp end={90} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-xs uppercase tracking-wider">Project Success Rate</p>
                                </div>
                                <div className="p-2.5">
                                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-2"><CountUp end={100} suffix="%" /></h3>
                                    <p className="text-gray-400 text-[11px] sm:text-xs uppercase tracking-wider">Safety Compliance</p>
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-12">
                                    <div className="bg-white/5 border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-10 hover:border-blue-500/30 transition-all">
                                        <div className="w-11 h-11 sm:w-16 sm:h-16 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-400 mb-4 sm:mb-6">
                                            <Target size={22} />
                                        </div>
                                        <h3 className="text-lg sm:text-2xl font-bold text-white mb-3 sm:mb-4">Single-Point Execution Accountability</h3>
                                    ...
                                    <div className="bg-white/5 border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-10 hover:border-blue-500/30 transition-all">
                                        ...
                                        <h3 className="text-lg sm:text-2xl font-bold text-white mb-3 sm:mb-4">Integrated Cost & Timeline Control</h3>
                                        <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                    ...
                    {/* 4. CORE EPC SERVICES */}
                    <section className="py-10 md:py-24 px-4 md:px-12 bg-white/5 animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-200">
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto">
                                    ...
                                    {coreServices.map((service, index) => (
                                        <div key={index} className="group relative p-4 sm:p-8 rounded-2xl border border-white/10 overflow-hidden hover:border-blue-500/30 transition-all shadow-lg backdrop-blur-xl bg-gradient-to-r from-transparent to-white/5 hover:to-blue-600/10 animated-white-border">
                                            ...
                                            <div className="relative z-10">
                                                ...
                                                <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-8 leading-relaxed min-h-[56px]">{service.desc}</p>

                                                <div className="bg-black/20 rounded-xl p-4 sm:p-6 border border-white/5 group-hover:border-white/10 transition-colors">
                                                    <h4 className="text-xs sm:text-sm font-semibold text-gray-300 mb-3 sm:mb-4 uppercase tracking-wide">Capabilities:</h4>
                                                    <ul className="grid grid-cols-1 gap-2.5 sm:gap-3">
                                                        {service.items.map((item, idx) => (
                                                            <li key={idx} className="flex items-start text-xs sm:text-sm text-gray-400">
                                                                <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-2 text-blue-500 mt-0.5 shrink-0" />
                                                                {item}
                                                            </li>
                                                        ))}
                                                    </ul>
                    ...
                    <section className="py-12 md:py-24 px-4 md:px-6 animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-300">
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6 lg:gap-16 items-center">
                                <div className="w-full lg:w-1/2 text-center lg:text-left">
                                    <div className="relative">
                                        <div className="absolute inset-0 bg-blue-600/20 blur-[100px] rounded-full pointer-events-none"></div>
                                        <div className="text-xs sm:text-sm text-blue-400 font-bold tracking-widest uppercase mb-3 sm:mb-4">Supply Chain Excellence</div>
                                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                                            End-to-End <br />
                                            <span className="text-blue-500">Supply Chain Visibility</span>
                                        </h2>
                                        <p className="text-sm sm:text-lg text-gray-300 mb-4 sm:mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                                        ...
                                        <div className="space-y-2.5 sm:space-y-4 text-left max-w-md mx-auto lg:mx-0">
                                            {[
                                                ...
                                                <div key={i} className="flex items-start gap-2.5 sm:gap-3">
                                                    <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 mt-0.5">
                                                        <CheckCircle size={14} />
                                                    </div>
                                ...
                                <div className="w-full lg:w-1/2">
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="space-y-3 lg:translate-y-8">
                                            <div className="bg-white/5 p-4 sm:p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
                                                <Globe className="w-8 h-8 sm:w-10 sm:h-10 text-blue-500 mb-3 sm:mb-4" />
                                                <h4 className="text-sm sm:text-base font-bold text-white mb-1.5 sm:mb-2">Global Sourcing</h4>
                                                <p className="text-xs sm:text-sm text-gray-400">International vendor network access.</p>
                                            </div>
                                            <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-4 sm:p-6 rounded-2xl text-white">
                                                <h4 className="font-bold text-lg sm:text-xl mb-1.5 sm:mb-2">92%</h4>
                                                <p className="text-xs sm:text-sm text-blue-100">Vendor Performance Efficiency</p>
                                            </div>
                                        </div>
                                        <div className="space-y-3">
                                            <div className="bg-white/10 p-4 sm:p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
                                                <Truck className="w-8 h-8 sm:w-10 sm:h-10 text-green-500 mb-3 sm:mb-4" />
                                                <h4 className="text-sm sm:text-base font-bold text-white mb-1.5 sm:mb-2">Logistics</h4>
                                                <p className="text-xs sm:text-sm text-gray-400">Optimized delivery routes & timing.</p>
                                            </div>
                                            <div className="bg-white/5 p-4 sm:p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
                                                <Database className="w-8 h-8 sm:w-10 sm:h-10 text-purple-500 mb-3 sm:mb-4" />
                                                <h4 className="text-sm sm:text-base font-bold text-white mb-1.5 sm:mb-2">Benchmarking</h4>
                                                <p className="text-xs sm:text-sm text-gray-400">Real-time cost data analysis.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section className="py-10 md:py-24 px-4 md:px-12 bg-white/5 animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-400">
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto">
                                <div className="text-center mb-8 md:mb-16">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                                    {specializedCapabilities.map((cap, index) => (
                                        <div key={index} className="bg-black/40 border border-white/10 rounded-2xl p-4 sm:p-8 hover:border-blue-500/50 transition-all group">
                                            <cap.icon className="w-9 h-9 sm:w-12 sm:h-12 text-blue-500 mb-4 sm:mb-6 group-hover:scale-110 transition-transform" />
                                            <h3 className="text-lg sm:text-xl font-bold text-white mb-2.5 sm:mb-3">{cap.title}</h3>
                                            <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-6">{cap.desc}</p>
                    ...
                    <section className="py-10 md:py-24 px-4 md:px-12 bg-black backdrop-blur-sm border-y border-white/5 animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-500">
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto">
                                <div className="text-center mb-8 md:mb-16">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-12">
                                    ...
                                    <div className="space-y-4 sm:space-y-8">
                                        <div className="text-center mb-4 sm:mb-8">
                                            <h3 className="text-xl sm:text-2xl font-bold text-red-400 mb-2">Without Integrated EPC Management</h3>
                                            <p className="text-xs sm:text-sm text-gray-400">Fragmented Execution & High Risk</p>
                                        </div>
                                        <div className="space-y-3 sm:space-y-6">
                                            {[
                                                ...
                                                <div key={index}>
                                                    <div className="flex justify-between text-xs sm:text-sm font-medium text-gray-400 mb-2">
                                                        <span className="pr-3">{item.label}</span>
                                                        <span className="text-red-400 shrink-0">Inefficient</span>
                                                    </div>
                                        ...
                                        <div className="p-3 sm:p-4 rounded-2xl bg-red-500/10 border border-red-500/20 mt-4 sm:mt-8">
                                    ...
                                    <div className="space-y-4 sm:space-y-8 relative">
                                        ...
                                        <div className="text-center mb-4 sm:mb-8">
                                            <h3 className="text-xl sm:text-2xl font-bold text-blue-400 mb-2">With MANO EPC Services</h3>
                                            <p className="text-xs sm:text-sm text-gray-400">Unified, Accelerated & Optimized</p>
                                        </div>
                                        <div className="space-y-3 sm:space-y-6">
                                            {[
                                                ...
                                                <div key={index}>
                                                    <div className="flex justify-between text-xs sm:text-sm font-medium text-gray-400 mb-2">
                                                        <span className="pr-3">{item.label}</span>
                                                        <span className="text-blue-400 shrink-0">Optimized</span>
                                                    </div>
                                                    <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                                                        <AnimatedBar width={item.percentage} color={item.color} delay={index * 200} />
                                                    </div>
                                        ...
                                        <div className="p-3 sm:p-4 rounded-2xl bg-blue-500/10 border border-blue-500/20 mt-4 sm:mt-8">
                    ...
                    <section className="py-10 md:py-24 px-4 md:px-12 animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-600">
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto rounded-2xl sm:rounded-3xl bg-gradient-to-r from-blue-900/40 to-black border border-white/10 p-4 sm:p-8 md:p-16 relative overflow-hidden">
                                ...
                                <div className="relative z-10 flex flex-col lg:flex-row items-center gap-6 lg:gap-12">
                                    <div className="w-full lg:w-1/2">
                                        <h2 className="text-2xl sm:text-4xl font-bold text-white mb-4 sm:mb-6 leading-tight">Digital EPC Management Systems</h2>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                            {[
                                                ...
                                                <div key={i} className="flex items-center gap-2.5 sm:gap-3 bg-white/5 p-2.5 sm:p-3 rounded-lg border border-white/5">
                                    ...
                                    <div className="w-full lg:w-1/2 flex justify-center">
                                        ...
                                        <div className="w-full max-w-sm bg-black/60 backdrop-blur-xl border border-white/10 rounded-xl p-4 sm:p-6 shadow-2xl">
                                            ...
                                            <div className="space-y-3 sm:space-y-4">
                                                <div className="h-20 sm:h-24 bg-white/5 rounded-lg border border-white/5 flex items-end p-3 sm:p-4 gap-2">
                    ...
                    {/* 9. WHY MANO FOR EPC */}
                    <section className="py-10 md:py-24 px-4 md:px-12 bg-white/5 animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-700">
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto">
                                <div className="text-center mb-8 md:mb-16">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                                    {[
                                        ...
                                        <div key={i} className="text-center p-4 sm:p-8 rounded-2xl border border-white/10 hover:bg-white/5 transition-all">
                                            <div className="w-11 h-11 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-blue-600 to-blue-800 mx-auto flex items-center justify-center text-white mb-4 sm:mb-6 shadow-lg shadow-blue-900/20">
                                                <item.icon size={22} />
                                            </div>
                                            <h3 className="text-lg sm:text-xl font-bold text-white mb-2.5 sm:mb-3">{item.title}</h3>
                    ...
                    {/* 11. PROCESS FLOW */}
                    <section className="py-12 md:py-24 px-4 md:px-12 bg-black relative overflow-hidden animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-900">
                        {/* Background Decor */}
                        ...
                        <RevealOnScroll>
                            <div className="max-w-7xl mx-auto">
                                <div className="text-center mb-8 md:mb-20">
                                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight">EPC Delivery <span className="text-blue-500">Process Flow</span></h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                    {processFlow.map((step, index) => (
                                        <div key={index} className="group relative p-4 sm:p-8 md:p-12 rounded-2xl sm:rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent backdrop-blur-xl overflow-hidden hover:to-blue-600/10 transition-all duration-500">
                                            ...
                                            {/* Number Watermark */}
                                            <div className="absolute top-4 right-4 sm:right-6 text-5xl sm:text-7xl font-black text-white/[0.03] group-hover:text-blue-500/[0.05] transition-colors pointer-events-none select-none font-mono">
                                            ...
                                            <div className="relative z-10">
                                                ...
                                                <h3 className="text-base sm:text-lg font-bold text-white mb-2 sm:mb-3 pr-8 group-hover:text-blue-400 transition-colors">
                                                    {step.title}
                                                </h3>

                                                {/* Decoration Lines */}
                                                <div className="flex gap-1 mt-4 sm:mt-6 opacity-30 group-hover:opacity-100 transition-opacity duration-500">
                    ...
                    {/* 12. TRUST STATEMENT */}
                    <section className="py-10 md:py-24 px-4 md:px-12 text-center animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-1000">
                    ...
                    {/* 13. CTA */}
                    <section className="py-10 md:py-24 relative overflow-hidden animate-in fade-in duration-1000 slide-in-from-bottom-10 delay-1000">
                        <div className="absolute inset-0 bg-blue-900/20"></div>
                        <div className="max-w-6xl mx-auto px-4 md:px-12 text-center relative z-10">
                            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white mb-5 sm:mb-6 leading-tight">Integrate Engineering, Procurement & Execution Seamlessly.</h2>
                                ...
                                <div className="cursor-pointer" onClick={() => setIsModalOpen(true)}>
                                    <RainbowButton buttonClassName="px-3 py-2 sm:px-8 sm:py-4 text-xs sm:text-lg">
                                        <span className="flex items-center text-xs sm:text-lg font-semibold px-0.5 sm:px-4">
                                            Start Your EPC Project <ChevronRight className="ml-1.5 w-3.5 h-3.5 sm:ml-2 sm:w-5 sm:h-5" />
                                        </span>
                                    </RainbowButton>
                                </div>
