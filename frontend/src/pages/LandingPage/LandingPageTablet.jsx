          ...
          <div className={`max-w-7xl mx-auto ${isEPC ? 'flex justify-center' : 'grid grid-cols-1 md:grid-cols-2'} gap-8`}>
            {
              (isEPC ? [
                ...
                <Link
                  ...
                  className={`group relative h-[420px] sm:h-[380px] rounded-3xl overflow-hidden border border-white/10 hover:border-blue-500/50 transition-all duration-500 shadow-2xl animated-white-border flex flex-col justify-end ${isEPC ? 'w-full max-w-4xl' : ''}`}
                >
